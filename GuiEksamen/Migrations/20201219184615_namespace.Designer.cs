...
namespace GuiEksamen.Migrations
{
    ...
    [Migration("20201219184615_namespace")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GuiEksamen.Models.Entities.EfExpense", b =>
                {
            ...
            modelBuilder.Entity("GuiEksamen.Models.Entities.EfJob", b =>
                {
            ...
            modelBuilder.Entity("GuiEksamen.Models.Entities.EfJobModel", b =>
                {
                    b.Property<long>("EfJobId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("GuiEksamen.Models.Entities.EfModel", b =>
                {
                    b.Property<long>("EfModelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("GuiEksamen.Models.Entities.EfExpense", b =>
                {
                    b.HasOne("GuiEksamen.Models.Entities.EfModel", null)
                        .WithMany("Expenses")
            ...
            modelBuilder.Entity("GuiEksamen.Models.Entities.EfJobModel", b =>
                {
                    b.HasOne("GuiEksamen.Models.Entities.EfJob", "Job")
                        .WithMany("JobModels")
                        .HasForeignKey("EfJobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GuiEksamen.Models.Entities.EfModel", "Model")
                        .WithMany("JobModels")
                        .HasForeignKey("EfModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
